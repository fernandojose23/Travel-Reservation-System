	...
	require 'includes/Exception.php';
     ...
     $body = '  <body>
                    ...
                    <div  style="margin-left:20px;">
                        ...
                        <h5>Sub Amount: '.$amount.'</h5></br>
                        <h5>Total Amount: '.$totals.'</h5></br>
                    </div>
                    <div  style="margin-left:20px;">
                        <p class="">Sincerely:</p>
                        <p class="">Escape.me.</p>
    ...
    <div id='printMe'>
        <div class="ticket ticket-1" style="background-image: url('<?php echo $location['picture']; ?>');
            ...
            <div class="artist" >
                ...
                <span class="live small" style="font-size: 20px">Charge for Accomodation: <?php echo $_GET['chargedTotal']; ?></span>
                </br>
                <span class="live small" style="font-size: 20px">Accomodation: <?php echo $_GET['acco']; ?></span>
            ...
            <div class="location" style="margin-left: 12vw;">
                ...
                <span class="small"><span><b>Price: </b><?php echo $english_format_number = number_format($_GET['total']); ?></span>
            </div>
