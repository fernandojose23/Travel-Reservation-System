    ...
    <script>
        ...
        document.getElementById('button').onclick = function() {
            ...
            if(txtValue == "" || txtValue2 == "" || txtValue3 == "" || txtValue5 == "" || txtValue6 == ""){
                ...
                window.location.href = "addReservation.php?locationID="+id+"&total="+getTotal+"&chargedTotal="+result8.innerText+"&name="+txtValue+"&email="+txtValue2+"&phone="+txtValue3+"&person="+txtValue5+"&acco="+txtValue6;
